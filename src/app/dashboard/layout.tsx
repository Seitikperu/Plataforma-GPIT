...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    <aside className="flex flex-col h-full">
      ...
      <div className="px-4 py-5 border-b border-slate-700/50">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-sm font-bold text-white tracking-tight">GPIT Platform</div>
      ...
      <div className="px-3 py-4 border-t border-slate-700/50">
        <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-slate-700/30 transition">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-500 truncate capitalize">{perfil?.rol}</p>
          </div>
          <button
  ...
  return (
    <div className="flex h-screen bg-slate-950 overflow-hidden">
      {/* Sidebar desktop */}
      <div className="hidden lg:flex flex-col w-64 bg-slate-900 border-r border-slate-700/50 flex-shrink-0">
        <Sidebar />
      </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top bar mobile */}
        <header className="lg:hidden flex items-center gap-3 px-4 h-14 bg-slate-900 border-b border-slate-700/50 flex-shrink-0">
          <button
          ...
          <span className="text-sm font-bold text-white">GPIT Platform</span>
        </header>
